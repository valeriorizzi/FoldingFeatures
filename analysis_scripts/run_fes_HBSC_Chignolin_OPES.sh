cd a
rm temp*
./../../FES_from_Reweighting_multiT_funnel.py --sigma 0.5 --colvar COLVAR.* --cv diffHB_compact --bin 150 --temp 340 --skip 20000 --deltaFat -10 --out fes_HB.dat --min -50 --max 5;
./../../FES_from_Reweighting_multiT_funnel.py --sigma 0.2 --colvar COLVAR.* --cv cmap_compact --bin 100 --temp 340 --skip 20000 --deltaFat 5 --blocks 3 --out fes_SC.dat --min -5 --max 8;
